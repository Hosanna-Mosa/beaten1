  ...
  return (
    <Box sx={{ overflowX: 'hidden', width: '100%' }}>
      ...
      >
        ...
        >
          <svg width="24" height="24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 8, opacity: 0.85 }}><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
          <input
            type="text"
      ...
      <Box sx={{ py: { xs: 4, md: 8 }, bgcolor: 'white', position: 'relative' }}>
        <Container maxWidth="xl">
          ...
          <Grid container spacing={0} sx={{ mt: 1.5, flexWrap: { xs: 'wrap', md: 'nowrap' }, overflowX: 'hidden', py: { xs: 0, md: 2 }, justifyContent: { xs: 'flex-start', md: 'center' } }}>
            {(() => {
              const cats = [
                ...
                if (isLast && isOdd) {
                  return (
                    <Grid 
                      ...
                      md={2.4}
                      key={cat.label}
                      sx={{ display: 'flex', justifyContent: { xs: 'center', sm: 'center', md: 'flex-start' }, p: 0, mx: { xs: 'auto', sm: 'auto', md: 0 } }}
                    >
                      <Card 
                        elevation={0} 
                        sx={{ 
              ...
              if (cats.length % 2 === 1) {
                items.push(
                  <Grid item xs={6} sm={6} md={2.4} key="empty-category" sx={{ display: { xs: 'none', md: 'flex' } }} />
                );
              }
              return items;
            })()}
      ...
      {[
        { name: 'T-SHIRTS', key: 't-shirts', image: '/images/category1Desktip.png' },
        { name: 'SHIRTS', key: 'shirts', image: '/images/shirts.png' },
        { name: 'OVERSIZED T-SHIRTS', key: 'oversized-t-shirts', image: '/images/oversized-tshirts.png' },
        { name: 'BOTTOM WEAR', key: 'bottom-wear', image: '/images/bottom wear.png' },
        { name: 'CARGO PANTS', key: 'cargo-pants', image: '/images/cargo pants.png' },
        { name: 'JACKETS', key: 'jackets', image: '/images/jackets.png' },
        { name: 'HOODIES', key: 'hoodies', image: '/images/hoodies.png' },
        { name: 'CO-ORD SETS', key: 'co-ord-sets', image: '/images/co-ord sets.png' }
      ].map((section, idx) => (
