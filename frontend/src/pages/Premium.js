  ...
  const faqs = [
    {
      ...
      answer: 'As a Premium member, you automatically get ₹249 off on every order you place. The discount is applied at checkout, and there\'s no minimum order value required. This discount can be combined with other ongoing promotions and offers.'
    },
    {
    ...
    },
    {
      ...
      answer: 'No, there are no hidden fees. The ₹249 yearly subscription fee is the only charge you\'ll pay. All premium benefits, including the ₹249 discount on orders, priority shipping, and premium support, are included at no additional cost.'
    }
  ];
