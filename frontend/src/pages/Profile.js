          ...
          <Grid item xs={12} md={8}>
            <Paper elevation={2} sx={{ p: { xs: 3, md: 4 }, mb: 4, borderRadius: 3, boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', mb: 2 }}>
                ...
                <Button startIcon={<EditIcon />} onClick={() => setIsEditing(!isEditing)} variant="contained" color="primary"
                  sx={{
            ...
            <Paper elevation={2} sx={{ p: { xs: 3, md: 4 }, mb: 4, borderRadius: 3, boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', mb: 2 }}>
                ...
                <Button size="small" variant="contained" color="primary" startIcon={<AddLocationIcon />}
                  sx={{
                    backgroundColor: matteColors[900],
                    color: 'white',
                    py: { xs: 0.7, md: 1 },
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={2} sx={{ p: { xs: 3, md: 4 }, mb: 4, borderRadius: 3, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', textAlign: 'center' }}>
              ...
              {membership.isPremium ? (
                ...
                <Button variant="contained" color="primary" fullWidth onClick={() => navigate('/premium')}
                  sx={{
                    backgroundColor: matteColors[900],
                    color: 'white',
                    py: { xs: 0.7, md: 1 },
            ...
            <Paper elevation={2} sx={{ p: { xs: 3, md: 4 }, mb: 4, borderRadius: 3, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', textAlign: 'center', background: 'linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%)' }}>
              <Box sx={{ mb: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <Typography variant="h6" sx={{ fontWeight: 600, color: 'text.primary', mb: 0 }}>
                  <Box component="span" sx={{ display: 'inline-flex', alignItems: 'center', gap: 1 }}>
