...
const orders = [
  {
    ...
    items: [
      { name: 'Black Graphic T-shirt', image: 'https://i.pinimg.com/736x/65/f3/21/65f3213693e94dacf246dac482c8e996.jpg', qty: 1, price: 999 },
      { name: 'Oversized Hoodie', image: 'https://i.pinimg.com/736x/65/f3/21/65f3213693e94dacf246dac482c8e996.jpg', qty: 1, price: 1500 }
    ]
  },
  {
    _id: 'ORD-1002',
    ...
    items: [
      { name: 'White Cap', image: 'https://i.pinimg.com/736x/65/f3/21/65f3213693e94dacf246dac482c8e996.jpg', qty: 1, price: 1799 }
    ]
  },
  {
    _id: 'ORD-1003',
    ...
    items: [
      { name: 'Joggers', image: 'https://via.placeholder.com/80x80?text=Joggers', qty: 1, price: 1499 },
      { name: 'Sneakers', image: 'https://via.placeholder.com/80x80?text=Sneakers', qty: 1, price: 1799 },
      { name: 'Socks', image: 'https://via.placeholder.com/80x80?text=Socks', qty: 1, price: 201 }
    ]
  }
];
...
const Orders = () => {
  ...
  return (
    <Container maxWidth="md" sx={{ py: { xs: 3, md: 6 } }}>
          ...
          <Grid item xs={12} key={order._id}>
            {isMobile ? (
              ...
              <Paper elevation={3} sx={{
                ...
                >
                  {expandedOrders.includes(order._id) ? <ExpandLessIcon /> : <ExpandMoreIcon />}
                </Button>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, flex: 1, mb: 2 }}>
                  {(expandedOrders.includes(order._id) ? order.items : order.items.slice(0, 2)).map((item, idx) => (
                    <Box key={idx} sx={{ display: 'flex', alignItems: 'center', gap: 2, width: '100%' }}>
                      <Avatar
                      ...
                      />
                      <Typography variant="body1" sx={{ fontWeight: 500, color: 'text.primary', flex: 1, minWidth: 0, pr: 1, overflowWrap: 'break-word', whiteSpace: 'normal', fontSize: '0.9rem' }}>
                        {item.name}
                      </Typography>
                      {expandedOrders.includes(order._id) && (
                        <Button
                          ...
                          onClick={() => handleOpenReturnDialog(order._id, item, idx)}
                        >
                          Return/Exchange
                        </Button>
                      )}
                  ...
                  <>
                    ...
                    <Box sx={{ mb: 2, mt: 1 }}>
                      ...
                      <Chip
                        ...
                        sx={{ fontWeight: 600, fontSize: '1rem', px: 2, py: 1, mt: 1 }}
                      />
                    </Box>
                    {/* Action Buttons */}
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, flexWrap: 'wrap', mt: 1 }}>
                      <Button
                        variant="outlined"
                        startIcon={<ViewIcon />}
                        sx={{
                      ...
                      <Button
                        ...
                        onClick={() => alert('Exchange/Return feature coming soon!')}
                        fullWidth={isMobile}
                      >
                        Exchange or Return
                      </Button>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap', mb: 1 }}>
                  {order.items.map((item, idx) => (
                    <Box key={idx} sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <Avatar src={item.image || PLACEHOLDER_IMAGE} alt={item.name} sx={{ width: 48, height: 48, borderRadius: 2, bgcolor: '#fafafa', border: '1px solid #eee' }} />
            ...
            <Box>
              ...
              {selectedOrder.items.map((item, idx) => (
                <Box key={idx} sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
                  <Avatar src={item.image || PLACEHOLDER_IMAGE} alt={item.name} sx={{ width: 40, height: 40, borderRadius: 2, bgcolor: '#fafafa', border: '1px solid #eee' }} />
                  <Box>
      ...
      <Dialog open={returnDialogOpen} onClose={handleCloseReturnDialog} maxWidth="xs" fullWidth>
        <form onSubmit={handleSubmitReturn}>
          ...
          <DialogActions>
            ...
            <Button type="submit" variant="contained" color="primary" disabled={!returnReason}>Submit</Button>
          </DialogActions>
        </form>
      </Dialog>
